...
int main(void)
{
  ...
  TM_HD44780_Init(16, 2);
  TM_HD44780_CreateChar(0, customChar);
  itoa(val1, beseda1, 10);
  TM_HD44780_Puts(5, 1, beseda1);
  for(int val1=0 ; val1 <= 20 ; val1++ ){
	TM_HD44780_Clear();
	TM_HD44780_ScrollRight;
	TM_HD44780_BlinkOn;
	HAL_Delay(500);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : OTG_FS_PowerSwitchOn_Pin D5_Pin D6_Pin D7_Pin */
  GPIO_InitStruct.Pin = OTG_FS_PowerSwitchOn_Pin|D5_Pin|D6_Pin|D7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
